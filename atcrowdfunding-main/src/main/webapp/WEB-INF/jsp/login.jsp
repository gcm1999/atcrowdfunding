  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="loginForm" class="form-signin" role="form" action="${PATH }/login" method="post">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
		  ...
		  <div class="form-group has-success has-feedback">
			<input type="password" class="form-control" id="userpwd" name="userpswd" value="666666" placeholder="请输入登录密码" style="margin-top:10px;">
    ...
    function dologin() {
    	...
    	if($.trim(loginacct) == ""){
    		...
    		layer.msg("用户名称不能为空，请输入用户名",{time:1000,icon:5});

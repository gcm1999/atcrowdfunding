              ...
              <c:forEach items="${page.list }" var="admin" varStatus="status">
	                <tr>
	                  ...
	                  <td>
						  ...
						  <button type="button" adminId="${admin.id }" class="deleteBtnClass deleteBtnClass btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>
					  </td>
	                </tr>
                </c:forEach>
              </tbody>
   ...
   <%@ include file="/WEB-INF/jsp/common/js.jsp"%>
        <script type="text/javascript">
            ...
            $(".deleteBtnClass").click(function(){
            	...
            	layer.confirm('您确认删除该条数据吗?',{btn:['确认','取消']},function(index){
...
//             	$("tbody input[type='checkbox']").attr("checked",this.checked);  /主要处理自定义属性
            ...
            $("#deleteBatchBtn").click(function(){
            	...
            	ids = array.join(",");
//             	console.log(ids);
				layer.confirm('您确认删除这些数据吗?',{btn:['确认','取消']},function(index){
